...
export default defineConfig({
  ...
  webServer: [
    ...
    {
      command: `env PORT=${serverPort.toString()} CLIENT_ORIGIN=${clientBaseUrl} ANALYSIS_MODEL_PROVIDER=deterministic DEBUGGING_DIAGNOSIS_MODEL_PROVIDER=deterministic TUTOR_MODEL_PROVIDER=deterministic SEMANTIC_GUARD_PROVIDER=deterministic EMBEDDING_PROVIDER=deterministic GEMINI_CHAT_PROJECTS_JSON='[]' RETRIEVAL_MIN_SIMILARITY=0 npm run dev:server`,
