...
export default defineConfig({
  ...
  webServer: [
    ...
    {
      command: `env CLIENT_ORIGIN=${clientBaseUrl} EMBEDDING_PROVIDER=deterministic COMPLETION_PROVIDER=deterministic RETRIEVAL_MIN_SIMILARITY=0 npm run dev:server`,
