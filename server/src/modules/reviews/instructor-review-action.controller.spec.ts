...
describe('InstructorReviewQueueController terminal actions', () => {
  ...
  beforeAll(async () => {
    const moduleFixture = await Test.createTestingModule({
      controllers: [InstructorReviewQueueController],
      providers: [
        { provide: InstructorReviewQueueService, useValue: {} },
        { provide: InstructorReviewDetailService, useValue: {} },
        {
