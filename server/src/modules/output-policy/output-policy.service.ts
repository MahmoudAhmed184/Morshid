...
export class OutputPolicyService {
  evaluate(input: OutputPolicyInput): OutputPolicyDecision {
...
function collectReasons(input: OutputPolicyInput): AutomaticPolicyReason[] {
...
function assertNever(_value: never): never {
  throw new TypeError('Invalid output-policy assessment')
}
