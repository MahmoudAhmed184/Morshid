...
describe('RBAC (e2e)', () => {
  ...
  describe('Student boundaries', () => {
     ...
     */
    it.skip(
      'student cannot call POST /api/v1/admin/users',
      async () => {
        const token = await signInAndGetToken(app, 'student1@morshid.demo')
     ...
     */
    it.skip(
      'student cannot list users via GET /api/v1/admin/users',
      async () => {
        const token = await signInAndGetToken(app, 'student1@morshid.demo')
     ...
     */
    it.skip(
      'student cannot update a user via PATCH /api/v1/admin/users/:id',
      async () => {
        const token = await signInAndGetToken(app, 'student1@morshid.demo')
     ...
     */
    it.skip(
      'student cannot create a course via POST /api/v1/admin/courses',
      async () => {
        const token = await signInAndGetToken(app, 'student1@morshid.demo')
     ...
     */
    it.skip(
      'student cannot upload materials via instructor endpoints',
      async () => {
        const token = await signInAndGetToken(app, 'student1@morshid.demo')
     ...
     */
    it.skip(
      'student cannot access the instructor review queue',
      async () => {
        const token = await signInAndGetToken(app, 'student1@morshid.demo')
  ...
  describe('Instructor boundaries', () => {
     ...
     */
    it.skip(
      'instructor cannot list users via GET /api/v1/admin/users',
      async () => {
        const token = await signInAndGetToken(app, 'instructor@morshid.demo')
     ...
     */
    it.skip(
      'instructor cannot create a user via POST /api/v1/admin/users',
      async () => {
        const token = await signInAndGetToken(app, 'instructor@morshid.demo')
     ...
     */
    it.skip(
      'instructor cannot disable a user via PATCH /api/v1/admin/users/:id/disable',
      async () => {
        const token = await signInAndGetToken(app, 'instructor@morshid.demo')
     ...
     */
    it.skip(
      'instructor cannot create a course via POST /api/v1/admin/courses',
      async () => {
        const token = await signInAndGetToken(app, 'instructor@morshid.demo')
     ...
     */
    it.skip(
      'instructor cannot access materials of an unowned course',
      async () => {
        const token = await signInAndGetToken(app, 'instructor@morshid.demo')
  ...
  describe('Admin boundaries', () => {
     ...
     */
    it.skip(
      'admin can create a user via POST /api/v1/admin/users',
      async () => {
        const token = await signInAndGetToken(app, 'admin@morshid.demo')
     ...
     */
    it.skip(
      'admin can list users via GET /api/v1/admin/users',
      async () => {
        const token = await signInAndGetToken(app, 'admin@morshid.demo')
     ...
     */
    it.skip(
      'admin can disable a user via PATCH /api/v1/admin/users/:id/disable',
      async () => {
        const token = await signInAndGetToken(app, 'admin@morshid.demo')
     ...
     */
    it.skip(
      'admin can enable a user via PATCH /api/v1/admin/users/:id/enable',
      async () => {
        const token = await signInAndGetToken(app, 'admin@morshid.demo')
     ...
     */
    it.skip(
      'admin can create a course via POST /api/v1/admin/courses',
      async () => {
        const token = await signInAndGetToken(app, 'admin@morshid.demo')
     ...
     */
    it.skip(
      'admin can add a member via POST /api/v1/admin/courses/:courseId/members',
      async () => {
        const token = await signInAndGetToken(app, 'admin@morshid.demo')
     ...
     */
    it.skip(
      'admin can remove a member via DELETE /api/v1/admin/courses/:courseId/members/:userId',
      async () => {
        const token = await signInAndGetToken(app, 'admin@morshid.demo')
  ...
  describe('Course boundaries', () => {
     ...
     */
    it.skip(
      'student cannot create a session for an unassigned course',
      async () => {
        const token = await signInAndGetToken(app, 'student1@morshid.demo')
     ...
     */
    it.skip(
      'student cannot access materials of an unassigned course',
      async () => {
        const token = await signInAndGetToken(app, 'student1@morshid.demo')
