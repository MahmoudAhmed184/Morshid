...
import { Public } from '../../src/modules/identity/identity.public'
import { Roles } from '../../src/modules/identity/identity.roles'
...
describe('RolesGuard (e2e)', () => {
  ...
  it('blocks an @Roles(ADMIN) route with 401 when no token is provided', async () => {
    ...
    // The global IdentityGuard rejects with 401 before RolesGuard runs, so an
