...
-- CreateEnum
CREATE TYPE "tutor_candidate_generation_outcome" AS ENUM ('GENERATED', 'INVALID_OUTPUT', 'INFRASTRUCTURE_EXHAUSTED');
...
-- CreateEnum
CREATE TYPE "tutor_approval_source" AS ENUM ('VALIDATED_CANDIDATE', 'SAFE_FALLBACK', 'CLASSIFIED_RESPONSE');

-- CreateEnum
CREATE TYPE "tutor_safe_fallback_reason" AS ENUM ('VALIDATION_EXHAUSTED', 'GUARD_UNAVAILABLE', 'GENERATION_RETRY_FAILED');
...
CREATE TABLE "messages" (
    ...
    "error_message" TEXT,
    "grounding_attempt_id" UUID,
    "grounding_lease_expires_at" TIMESTAMPTZ(6),
    "created_at" TIMESTAMPTZ(6) NOT NULL DEFAULT CURRENT_TIMESTAMP,
...
-- CreateIndex
CREATE INDEX "idx_messages_grounding_lease" ON "messages"("session_id", "status", "grounding_lease_expires_at");
...
-- CreateIndex
CREATE UNIQUE INDEX "tutor_candidate_attempts_turn_attempt_key" ON "tutor_candidate_attempts"("turn_id", "candidate_attempt");

-- CreateIndex
CREATE UNIQUE INDEX "guard_results_turn_attempt_stage_key" ON "guard_results"("turn_id", "candidate_attempt", "validation_stage");
...
-- AddForeignKey
ALTER TABLE "tutor_candidate_attempts" ADD CONSTRAINT "tutor_candidate_attempts_turn_id_fkey" FOREIGN KEY ("turn_id") REFERENCES "tutor_turns"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "guard_results" ADD CONSTRAINT "guard_results_turn_id_candidate_attempt_fkey" FOREIGN KEY ("turn_id", "candidate_attempt") REFERENCES "tutor_candidate_attempts"("turn_id", "candidate_attempt") ON DELETE RESTRICT ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "teaching_decisions" ADD CONSTRAINT "teaching_decisions_turn_id_fkey" FOREIGN KEY ("turn_id") REFERENCES "tutor_turns"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
...
ALTER TABLE "tutor_candidate_attempts"
  ADD CONSTRAINT "tutor_candidate_attempts_attempt_check"
  CHECK ("candidate_attempt" BETWEEN 1 AND 3),
  ADD CONSTRAINT "tutor_candidate_attempts_tokens_check"
  CHECK (
    ("input_tokens" IS NULL OR "input_tokens" >= 0) AND
    ("output_tokens" IS NULL OR "output_tokens" >= 0) AND
    "infrastructure_retry_count" >= 0
  ),
  ADD CONSTRAINT "tutor_candidate_attempts_time_check"
  CHECK ("completed_at" >= "started_at"),
  ADD CONSTRAINT "tutor_candidate_attempts_content_check"
  CHECK (
