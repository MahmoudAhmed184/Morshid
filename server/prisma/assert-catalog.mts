...
const expectedIndexes = [
  ...
  'educational_analyses_turn_id_attempt_key',
  ...
  'guard_results_pkey',
  'guard_results_turn_attempt_stage_key',
  ...
  'idx_tutor_turns_student_message',
  'idx_tutor_turns_topic',
  ...
  'teaching_decisions_turn_id_key',
  'topic_states_pkey',
  'topic_states_topic_id_key',
  'topics_pkey',
  'tutor_candidate_attempts_pkey',
  'tutor_candidate_attempts_turn_attempt_key',
  'tutor_turns_approved_tutor_message_id_key',
  'tutor_turns_pkey',
  'tutor_turns_session_id_idempotency_key_key',
  'users_email_key',
  'users_pkey',
]
...
const expectedChecks = [
  ...
  'notifications_state_shape_check',
  ...
  'tutor_candidate_attempts_attempt_check',
  'tutor_candidate_attempts_content_check',
  'tutor_candidate_attempts_time_check',
  'tutor_candidate_attempts_tokens_check',
  'tutor_turns_approval_metadata_check',
...
const expectedForeignKeys = [
  ...
  'educational_analyses_turn_id_fkey',
  ...
  'guard_results_turn_id_candidate_attempt_fkey',
  ...
  'messages_turn_id_fkey',
  'notifications_recipient_user_id_fkey',
  'notifications_review_case_id_fkey',
  ...
  'teaching_decisions_turn_id_fkey',
  'topic_states_topic_id_fkey',
  'topics_course_id_fkey',
  'topics_session_id_fkey',
  'tutor_candidate_attempts_turn_id_fkey',
  'tutor_turns_approved_tutor_message_id_fkey',
  'tutor_turns_session_id_fkey',
  'tutor_turns_student_message_id_fkey',
  'tutor_turns_topic_id_fkey',
