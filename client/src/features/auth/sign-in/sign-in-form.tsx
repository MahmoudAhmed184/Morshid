    ...
    <Form {...form}>
      ...
      >
        ...
        <div className="flex flex-wrap items-center gap-1.5 pb-0.5">
          <span className="font-mono text-[0.62rem] sm:text-[0.65rem] uppercase tracking-wider text-slate-400 dark:text-slate-500 mr-0.5">
            Autofill:
          </span>
          <button
            type="button"
            onClick={() => fillDemo('instructor')}
            className="rounded-full border border-slate-200 dark:border-slate-700/60 bg-slate-100/90 dark:bg-slate-800/80 px-2.5 py-0.5 font-mono text-[0.62rem] sm:text-[0.65rem] font-medium text-slate-700 dark:text-slate-300 transition-colors hover:bg-slate-200 dark:hover:bg-slate-700"
          >
            Instructor
          </button>
          <button
            ...
            <div className="space-y-0">
              <div className="space-y-1.5 sm:space-y-2">
                ...
                <div className="relative">
                  ...
                  />
                  <Mail
                    className="pointer-events-none absolute right-3.5 top-1/2 size-4 -translate-y-1/2 text-slate-400 dark:text-slate-500"
                    aria-hidden
                  />
                </div>
              </div>
        ...
        {authErrorMessage ? (
          <div
            role="alert"
            className="flex items-start gap-2.5 rounded-xl border border-rose-200 dark:border-rose-900/60 bg-rose-50/90 dark:bg-rose-950/50 px-3.5 py-2.5 text-sm font-medium text-rose-800 dark:text-rose-300 shadow-xs"
          >
            <TriangleAlert
        ...
        <Button
          ...
          className="h-10 sm:h-11 md:h-12 w-full cursor-pointer items-center justify-center gap-2 rounded-full bg-[#111e38] dark:bg-[#1a4d54] text-sm font-semibold text-white shadow-md transition-all hover:bg-[#081120] dark:hover:bg-[#153e44] hover:shadow-lg mt-2 sm:mt-3"
        >
          <span>Sign in</span>
