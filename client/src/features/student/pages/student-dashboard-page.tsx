...
export function StudentDashboardPage() {
  ...
  return (
    <div className="flex flex-1 flex-col px-4 py-6 sm:px-6">
      ...
      <section className="mb-6 rounded-md border border-l-2 border-border border-l-rubric bg-card p-6 text-card-foreground sm:p-8">
        <div className="flex flex-col gap-5 sm:flex-row sm:items-center sm:justify-between">
          <div className="min-w-0">
            <span className="inline-flex items-center gap-1.5 rounded-sm bg-primary/10 px-2.5 py-1 text-xs font-medium text-primary">
              <Bot className="size-3.5" aria-hidden />
              AI Tutor
            </span>
            <h2 className="mt-3 font-display text-[1.75rem] leading-tight tracking-tight text-foreground">
              {continueCourse
      ...
      <section className="grid gap-4 sm:grid-cols-2">
        ...
        <Card className="justify-between">
          <CardContent className="flex items-start justify-between gap-3">
            ...
            <span
              className="flex size-11 items-center justify-center rounded-sm bg-gold/10 text-gold"
              aria-hidden
            >
