...
| Expected fixture data | `gd-p0-v1-058` in `fixtures/golden-dataset/debugging-guidance-p0.json`: a short code snippet under the P0 size limit, `CODE_DIAGNOSIS`, required `p0-npt-part-02` citation support, exactly one inspection step, and forbidden full corrected code. |
